  ...
  useEffect(() => {
    ...
    const fetchProperties = async () => {
      ...
      try {
        ...
        if (filters.minPrice) {
          params.append("minRent", filters.minPrice);
        }

        if (filters.maxPrice) {
          params.append("maxRent", filters.maxPrice);
        }
        ...
        const pageUrl = `/properties${queryString ? `?${queryString}` : ""}`;
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="animate-pulse h-10 w-24 bg-gray-200 rounded" />
        </div>
